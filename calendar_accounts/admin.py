...
from django.contrib.auth.forms import BaseUserCreationForm, AdminPasswordChangeForm, UsernameField
...
class CalendarUserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ('Personal data', {'fields': (
            'first_name', 'last_name', 'date_of_birth', 'date_joined', 'last_login', 'password_changed_at', 'profile_image',
